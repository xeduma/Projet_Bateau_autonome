...
/**
	 ...
	 */
	int8_t truncateStr(char instr[], char *outstr[], const char delimeter) {
	    char *tempBuff;
	    int8_t numberOfRawsOutArray = 0;
...
int main(void)
{
  ...
  HAL_UART_Transmit(&huart1,"AT+CGPSINFO\r\n",13,100);
  HAL_UART_Receive(&huart1,rxdata,50,100);
